<template>
  <div>
    ...
    <p>This simple example will allow you to test the Exceptionless client configuration by submitting messages and errors.</p>
    ...
    <div v-if="state.error">
      <p>Error message sent to Exceptionless:</p>
